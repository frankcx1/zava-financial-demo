...
Runs entirely on-device using Foundry Local + Snapdragon X NPU
"""
...
MODELS = {
    ...
    "phi-3.5-mini-instruct-qnn-npu:1": "Phi 3.5 Mini (QNN NPU)",
    "qnn-deepseek-r1-distill-qwen-1.5b": "DeepSeek R1 1.5B (QNN)",
}
...
<body>
    <div class="container">
        <header>
            ...
            <div>
                <span class="badge">Powered by Snapdragon X NPU</span>
            ...
            <div class="model-selector">
                ...
                <select id="modelSelect">
                    ...
                    <option value="phi-3.5-mini-instruct-qnn-npu:1">Phi 3.5 Mini (QNN NPU)</option>
                    <option value="qnn-deepseek-r1-distill-qwen-1.5b">DeepSeek R1 1.5B (QNN)</option>
                </select>
            </div>
        </header>
        ...
        <div id="chat-tab" class="tab-content">
            ...
            <div class="chat-container" id="chatContainer">
                <div class="message assistant-msg">
                    ...
                    <div>Hello! I am running locally on your Snapdragon X NPU. How can I help you today?</div>
                </div>
            </div>
...
if __name__ == '__main__':
    print("\n" + "="*50)
    print("Local NPU AI Assistant (Snapdragon Edition)")
